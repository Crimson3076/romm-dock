...
> been published here before, this one entry covers the *entire* commit history since forking from
> [danielcopper/romm-tender](https://github.com/danielcopper/romm-tender) — hence its size. Every release from here
> on will be scoped to just what changed since the last one. Issue links below point back to the upstream repo,
> since that's where they were originally filed, before the fork.
...
* add support for alpha and beta romm server versions ([#1272](https://github.com/danielcopper/romm-tender/issues/1272)) ([f6323ad](https://github.com/Crimson3076/romm-dock/commit/f6323ad0c43d5405855cbc8994554513c6ff47c4))
* **artwork:** apply sync covers via SetCustomArtworkForApp under the budget gate ([#1394](https://github.com/danielcopper/romm-tender/issues/1394)) ([39361fb](https://github.com/Crimson3076/romm-dock/commit/39361fb2298626357b5216f62517bd121082072e))
* **artwork:** user-triggered cleanup of orphaned grid images ([#1403](https://github.com/danielcopper/romm-tender/issues/1403)) ([5e84f60](https://github.com/Crimson3076/romm-dock/commit/5e84f604c9e865d9b76903676514e1471ec995e6))
* **assets:** new mark, restructured README, docs palette ([#1566](https://github.com/danielcopper/romm-tender/issues/1566)) ([6d17f8c](https://github.com/Crimson3076/romm-dock/commit/6d17f8c25be755009dd338a5c120c500cbee81bc))
* **auth:** add api-token sign-in for OIDC users ([#1333](https://github.com/danielcopper/romm-tender/issues/1333)) ([407db78](https://github.com/Crimson3076/romm-dock/commit/407db78cb9c189ec357a28e8832675654b7a11ca))
* **auth:** request roms.user.read scope for native play-session reads ([#1280](https://github.com/danielcopper/romm-tender/issues/1280)) ([3043cb5](https://github.com/Crimson3076/romm-dock/commit/3043cb597fa7c65906803db5de935d7d833ac937))
* **auth:** sign in with a RomM pairing code ([#1335](https://github.com/danielcopper/romm-tender/issues/1335)) ([061bf36](https://github.com/Crimson3076/romm-dock/commit/061bf3600b56bf0b331b9d3cb450314d3554a392))
* **auth:** sign out and signed-in connection actions ([#1336](https://github.com/danielcopper/romm-tender/issues/1336)) ([c544ef1](https://github.com/Crimson3076/romm-dock/commit/c544ef155244d2bc0c2def5c608ad14301b5aaf6))
* **brand:** add the TENDER banner lockup ([#1706](https://github.com/danielcopper/romm-tender/issues/1706)) ([17ccb76](https://github.com/Crimson3076/romm-dock/commit/17ccb76da991144ba00d2161cbfd9e16b7ac354c))
* **brand:** new mark — sync arrows around a button diamond ([#1586](https://github.com/danielcopper/romm-tender/issues/1586)) ([756df33](https://github.com/Crimson3076/romm-dock/commit/756df3385d4e97106c097d62458bcdbddb3e1781))
* **brand:** rename the plugin to Tender ([#1707](https://github.com/danielcopper/romm-tender/issues/1707)) ([96b4e54](https://github.com/Crimson3076/romm-dock/commit/96b4e54a4b81d8a6150ec8b1fcf13c34a17dd9e6))
* **collections:** add a collection naming mode to keep same-named types separate ([#1569](https://github.com/danielcopper/romm-tender/issues/1569)) ([4e54167](https://github.com/Crimson3076/romm-dock/commit/4e541678b5b86c0c3751909360425ded286778cd))
...
* **connection:** require RomM 4.9.0 (drop 4.8.x support) ([#1259](https://github.com/danielcopper/romm-tender/issues/1259)) ([cbe44fb](https://github.com/Crimson3076/romm-dock/commit/cbe44fb41b1bd4a466db3693030e4f8d3775f402))
* **cores:** per-game emulator/core override via RetroDECK -e + plugin DB ([#949](https://github.com/danielcopper/romm-tender/issues/949)) ([968df1d](https://github.com/Crimson3076/romm-dock/commit/968df1df44e36d7c9a4ce0fda42e84a8ca805671))
* **cores:** plugin owns emulator selection — per-platform core in settings.json, always -e, drop gamelist ([#953](https://github.com/danielcopper/romm-tender/issues/953)) ([384ec5e](https://github.com/Crimson3076/romm-dock/commit/384ec5eaf4241c2d19cad4d224a131b88c0fb6eb))
* **downloads:** find the game already on the device under a different name ([#1733](https://github.com/danielcopper/romm-tender/issues/1733)) ([8b4288e](https://github.com/Crimson3076/romm-dock/commit/8b4288e6cf56067833b5200069484e99ba387dd9)), closes [#260](https://github.com/danielcopper/romm-tender/issues/260)
* **downloads:** name multi-file ROM folders after a game playlist so ES-DE collapses them ([#952](https://github.com/danielcopper/romm-tender/issues/952)) ([d55ed09](https://github.com/Crimson3076/romm-dock/commit/d55ed0945d1c63f37e37d762a2db115265469068))
* **downloads:** pause/resume downloads — resumable single-file, Cloudflare-aware ([#1126](https://github.com/danielcopper/romm-tender/issues/1126)) ([1774db4](https://github.com/Crimson3076/romm-dock/commit/1774db419dbcb09aca243761b05570398b5a52c7))
* **downloads:** use ROM files already on the device instead of overwriting them ([#1712](https://github.com/danielcopper/romm-tender/issues/1712)) ([524f766](https://github.com/Crimson3076/romm-dock/commit/524f76678ed30362b82a5a04075dd4f7bee4861e))
* **launch:** add multi-disc disc picker ([#865](https://github.com/danielcopper/romm-tender/issues/865)) ([#1135](https://github.com/danielcopper/romm-tender/issues/1135)) ([8653242](https://github.com/Crimson3076/romm-dock/commit/8653242f58868d8f5d62fb120968f630474b44da))
...
* **launch:** resolve emulator defaults live from es_systems ([#1305](https://github.com/danielcopper/romm-tender/issues/1305)) ([8a2724f](https://github.com/Crimson3076/romm-dock/commit/8a2724f540fa8b9e3263009fb0b7b45663950688))
* **launch:** state-aware Resume button for an already-running game ([#1315](https://github.com/danielcopper/romm-tender/issues/1315)) ([70e7c4a](https://github.com/Crimson3076/romm-dock/commit/70e7c4a10743a08dcd881e3afac9e31799584541))
* **launch:** stop a running game from the game detail page ([#1612](https://github.com/danielcopper/romm-tender/issues/1612)) ([eeb8fdb](https://github.com/Crimson3076/romm-dock/commit/eeb8fdbf011d7756ebb9ca330a4f58a60fa4b3d2)), closes [#1587](https://github.com/danielcopper/romm-tender/issues/1587)
* **library:** capture rom version metadata and sibling group key ([#1304](https://github.com/danielcopper/romm-tender/issues/1304)) ([350cc7e](https://github.com/Crimson3076/romm-dock/commit/350cc7e25d48a9bf21e09dbe6fd4a3f7afa613ff))
...
* **library:** guarded version switching for downloaded games ([#1344](https://github.com/danielcopper/romm-tender/issues/1344)) ([5cb1d67](https://github.com/Crimson3076/romm-dock/commit/5cb1d67292049f4115dfe407a7044c0d54cf8065))
* **library:** one steam shortcut per sibling group with deterministic binding ([#1337](https://github.com/danielcopper/romm-tender/issues/1337)) ([1e61bec](https://github.com/Crimson3076/romm-dock/commit/1e61becca3a424536737eff9cfbb40b4541be815))
* **library:** skip unchanged collections via a completion stamp ([#1502](https://github.com/danielcopper/romm-tender/issues/1502)) ([c25906e](https://github.com/Crimson3076/romm-dock/commit/c25906e187e769bc8ddb716a7f9e78c7b89a8304))
* **playtime:** adopt RomM native play-session ingest (ADR-0018) ([#1281](https://github.com/danielcopper/romm-tender/issues/1281)) ([b5936bc](https://github.com/Crimson3076/romm-dock/commit/b5936bc3a00deb611417e8ee56fe075a770260aa))
* **playtime:** reconcile playtime from RomM notes on game-detail open ([#905](https://github.com/danielcopper/romm-tender/issues/905)) ([2e25eaf](https://github.com/Crimson3076/romm-dock/commit/2e25eaf08502c87d6aa8688364c31dc89aef7afa))
* **playtime:** restore session_count and last_played from native play sessions ([#1288](https://github.com/danielcopper/romm-tender/issues/1288)) ([f8f39b3](https://github.com/Crimson3076/romm-dock/commit/f8f39b35e6d457b659ceef4198598217fb5d189b))
* **prune:** add recovery-backed removed game cleanup ([#1577](https://github.com/danielcopper/romm-tender/issues/1577)) ([37fa65b](https://github.com/Crimson3076/romm-dock/commit/37fa65b443a8cd35eae0720f3b9b60cc326894aa))
* route PS2/PS3/etc... games to standalone emulators ([#1208](https://github.com/danielcopper/romm-tender/issues/1208)) ([c028a02](https://github.com/Crimson3076/romm-dock/commit/c028a02400ed7e40cffb6c03df0f417ae9f607e5))
* **saves:** copy a save into another slot ([#1556](https://github.com/danielcopper/romm-tender/issues/1556)) ([8ea893e](https://github.com/Crimson3076/romm-dock/commit/8ea893ed647300dac2043186c3349425ce80d028)), closes [#1523](https://github.com/danielcopper/romm-tender/issues/1523)
* **saves:** default new save slots to "autosave" to match Argosy and Grout ([f536663](https://github.com/Crimson3076/romm-dock/commit/f536663254b5683731f1548011f2b525dae7bd9c)), closes [#1529](https://github.com/danielcopper/romm-tender/issues/1529)
* **saves:** detect & gate save sync when savefiles_in_content_dir is on ([#239](https://github.com/danielcopper/romm-tender/issues/239)) ([#963](https://github.com/danielcopper/romm-tender/issues/963)) ([8ac2de2](https://github.com/Crimson3076/romm-dock/commit/8ac2de29a93da87e4aed5179a077e660c4b54dfe))
* **saves:** device-level save-sync serialization gate ([#1234](https://github.com/danielcopper/romm-tender/issues/1234) phase 2a) ([#1265](https://github.com/danielcopper/romm-tender/issues/1265)) ([ec06332](https://github.com/Crimson3076/romm-dock/commit/ec06332d1849f4e24df246c926967b44512cc15e))
* **saves:** drive sync from RomM negotiate ops for non-legacy slots ([#1234](https://github.com/danielcopper/romm-tender/issues/1234) phase 2b/2c) ([#1266](https://github.com/danielcopper/romm-tender/issues/1266)) ([0b745af](https://github.com/Crimson3076/romm-dock/commit/0b745af9051e0df7cbab50dc9e15609c875d17aa))
* **saves:** launch-gate funnel — one shared gate for all gaming-mode launches ([#1051](https://github.com/danielcopper/romm-tender/issues/1051)) ([#1149](https://github.com/danielcopper/romm-tender/issues/1149)) ([a4d9d4b](https://github.com/Crimson3076/romm-dock/commit/a4d9d4be48b8df95a2fce43f6fdeaf97af7fec2d))
* **saves:** negotiate inventory builder from confirmed-slot saves ([#1234](https://github.com/danielcopper/romm-tender/issues/1234) phase 1c) ([#1264](https://github.com/danielcopper/romm-tender/issues/1264)) ([345655b](https://github.com/Crimson3076/romm-dock/commit/345655b6cdc9b84952fa39b205ddfeca8c957ba0))
* **saves:** negotiate-sync adapter surface + wire schemas ([#1234](https://github.com/danielcopper/romm-tender/issues/1234) phase 1a) ([#1261](https://github.com/danielcopper/romm-tender/issues/1261)) ([08acb9a](https://github.com/Crimson3076/romm-dock/commit/08acb9a088cbf3ca0ddf433d811f1b40187642ed))
* **saves:** per-direction counts on the save-sync completion toast ([#1477](https://github.com/danielcopper/romm-tender/issues/1477)) ([b074b26](https://github.com/Crimson3076/romm-dock/commit/b074b26274d423e00cb6250d70122dec2ca2afd7))
* **saves:** resolve upload 409s through the gavel native core ([#1518](https://github.com/danielcopper/romm-tender/issues/1518)) ([8774d81](https://github.com/Crimson3076/romm-dock/commit/8774d81027ba610cbae087a815b0e926c203e249))
* **saves:** show the last known slots while RomM is unreachable ([#1756](https://github.com/danielcopper/romm-tender/issues/1756)) ([2a860d5](https://github.com/Crimson3076/romm-dock/commit/2a860d5d4d45e0721f7d2c962ad0dabcf5d3236d)), closes [#1755](https://github.com/danielcopper/romm-tender/issues/1755)
* **saves:** single-token memory-card extensions, keyed by RetroDECK system ([#904](https://github.com/danielcopper/romm-tender/issues/904)) ([040defd](https://github.com/Crimson3076/romm-dock/commit/040defd6a932a3ccfd259675562c43dcf62a6820))
* **saves:** store the server content_hash as the sync baseline; scheme parity becomes the no-history fallback ([#1469](https://github.com/danielcopper/romm-tender/issues/1469)) ([e285014](https://github.com/Crimson3076/romm-dock/commit/e28501450a4da3792042e41ebcb334ea5b13bcc9))
* **saves:** zip-aware content_hash matching RomM's per-entry scheme ([#1234](https://github.com/danielcopper/romm-tender/issues/1234) phase 1b) ([#1260](https://github.com/danielcopper/romm-tender/issues/1260)) ([9d38e8d](https://github.com/Crimson3076/romm-dock/commit/9d38e8ded666ca26d05b1bb187bfcadd3a5deb78))
* **scale:** chunked durable sync apply and large-library hardening ([#1380](https://github.com/danielcopper/romm-tender/issues/1380)) ([470506f](https://github.com/Crimson3076/romm-dock/commit/470506f2aed2d7de07c0c26447cdc46aed498578))
* **sync:** delta-restricted apply — resumes skip applied items for real ([#1396](https://github.com/danielcopper/romm-tender/issues/1396)) ([c0527e4](https://github.com/Crimson3076/romm-dock/commit/c0527e47be28d7adb38feee970e634f01c6bfc9f))
* **sync:** keep a computed preview alive when you leave the page ([#1788](https://github.com/danielcopper/romm-tender/issues/1788)) ([390aa0b](https://github.com/Crimson3076/romm-dock/commit/390aa0b9b62d9a45939d83e3747e73b3c3905762))
* **sync:** make time estimates skip-aware and finish the estimate surfaces ([#1402](https://github.com/danielcopper/romm-tender/issues/1402)) ([e354226](https://github.com/Crimson3076/romm-dock/commit/e3542268946b3bfe0affae86319aedee36cb0f18))
* **sync:** session memory budget — measure, warn, pause and resume before Steam's renderer cliff ([#1392](https://github.com/danielcopper/romm-tender/issues/1392)) ([1ba03ee](https://github.com/Crimson3076/romm-dock/commit/1ba03ee649a07177caa5aa740667777ffa861fd8))
* **ui:** add Own/All collection owner-scope filter with lazy identity ([#1537](https://github.com/danielcopper/romm-tender/issues/1537)) ([236514e](https://github.com/Crimson3076/romm-dock/commit/236514e3add18ee136db3f76b6c6b58ebd07354b)), closes [#1532](https://github.com/danielcopper/romm-tender/issues/1532)
* **ui:** add per-platform BIOS delete to the System page ([#934](https://github.com/danielcopper/romm-tender/issues/934)) ([73f2983](https://github.com/Crimson3076/romm-dock/commit/73f29835e41c3e51955dfbfedd7adb4eefb7e641))
* **ui:** advance the sync bar through fetch and cover sub-phases without backwards jumps ([#1410](https://github.com/danielcopper/romm-tender/issues/1410)) ([acf7917](https://github.com/Crimson3076/romm-dock/commit/acf79178d8f21a98c2a6d350fe3c9203b4a312b3))
* **ui:** busy-disable danger-zone removals with a spinner and progress counter ([#1451](https://github.com/danielcopper/romm-tender/issues/1451)) ([bb86c86](https://github.com/Crimson3076/romm-dock/commit/bb86c867bf4f72598448318e02ba52241b2f60c8))
* **ui:** confirm text-entry modals with the on-screen keyboard's Enter key ([#1563](https://github.com/danielcopper/romm-tender/issues/1563)) ([a8e0677](https://github.com/Crimson3076/romm-dock/commit/a8e06779e2990b3dbb8d5c6d7c9519a8512099a5)), closes [#1562](https://github.com/danielcopper/romm-tender/issues/1562)
* **ui:** highlight the active core in the game-page BIOS list ([#955](https://github.com/danielcopper/romm-tender/issues/955)) ([#959](https://github.com/danielcopper/romm-tender/issues/959)) ([fad88b1](https://github.com/Crimson3076/romm-dock/commit/fad88b17a4e083fc935794e824cfd0f41b541aa6))
...
* **ui:** per-game core menu — (system) marker + 'Use System Override' reset item ([#958](https://github.com/danielcopper/romm-tender/issues/958)) ([973672e](https://github.com/Crimson3076/romm-dock/commit/973672e6ac74a3de5d49f9ac9f522aea3cbfbd3f))
* **ui:** show last played from restored playtime data ([#1300](https://github.com/danielcopper/romm-tender/issues/1300)) ([39edeac](https://github.com/Crimson3076/romm-dock/commit/39edeac13486f8100df743b0a99cdd9cc49f6189))
* **ui:** show Space Required size on uninstalled games before download ([#1395](https://github.com/danielcopper/romm-tender/issues/1395)) ([#1526](https://github.com/danielcopper/romm-tender/issues/1526)) ([a303ba7](https://github.com/Crimson3076/romm-dock/commit/a303ba75297389a2db547d4efe0142761abacbc7))
* **ui:** version picker as a standalone game-detail control ([#1343](https://github.com/danielcopper/romm-tender/issues/1343)) ([c9b68d0](https://github.com/Crimson3076/romm-dock/commit/c9b68d0a0fbf88245926e365fafa30e1223c816f))
...
* **artwork:** cache covers per rom so version picker thumbnails persist per version ([#1357](https://github.com/danielcopper/romm-tender/issues/1357)) ([4261a7d](https://github.com/Crimson3076/romm-dock/commit/4261a7dfe7562940500240a7dda11c5a504713b1))
* **artwork:** fall back to url_cover when the RomM cover asset returns 404 ([#1453](https://github.com/danielcopper/romm-tender/issues/1453)) ([ea26da8](https://github.com/Crimson3076/romm-dock/commit/ea26da850fabdc332dd47ac639d5a7853242cb9f))
* **artwork:** invalidate the per-rom cover cache on server-side cover changes ([#1401](https://github.com/danielcopper/romm-tender/issues/1401)) ([be6ed13](https://github.com/Crimson3076/romm-dock/commit/be6ed1371f000f5f66d309f84cf7b2643e159902))
* **auth:** drop empty Bearer header that deadlocks fresh setup ([#950](https://github.com/danielcopper/romm-tender/issues/950)) ([27f6bae](https://github.com/Crimson3076/romm-dock/commit/27f6bae99e82a9de0ec9d952b6cd13590eaa81db)), closes [#928](https://github.com/danielcopper/romm-tender/issues/928)
* **bios:** tell a check that could not answer apart from one reporting no requirement ([#1703](https://github.com/danielcopper/romm-tender/issues/1703)) ([f528e23](https://github.com/Crimson3076/romm-dock/commit/f528e233caa0454143884b230c9bf91da7f37f85))
* **brand:** give the README banner its animation back ([#1710](https://github.com/danielcopper/romm-tender/issues/1710)) ([74ae758](https://github.com/Crimson3076/romm-dock/commit/74ae7589d88d0dc3b51aa950f6d0417bbdd3be3c))
* **build:** always chown the deploy dir recursively before syncing files ([#1127](https://github.com/danielcopper/romm-tender/issues/1127)) ([ee86420](https://github.com/Crimson3076/romm-dock/commit/ee86420b4ec7ac7ec353172e231250d3eff8c3ed))
* **ci:** copy the release zip somewhere writable before uploading ([#1711](https://github.com/danielcopper/romm-tender/issues/1711)) ([1044f1a](https://github.com/Crimson3076/romm-dock/commit/1044f1a8091d6c058bc4ec1df12d04dde5483640))
* **ci:** enforce deliberate version ceilings in Renovate + document where versions live ([#1253](https://github.com/danielcopper/romm-tender/issues/1253)) ([1d6639b](https://github.com/Crimson3076/romm-dock/commit/1d6639b901273986c6b8d796626a9876e900dfdb))
...
* **ci:** pin denoland/setup-deno comment to v2.0.4 to clear Renovate digest warning ([#1233](https://github.com/danielcopper/romm-tender/issues/1233)) ([734c257](https://github.com/Crimson3076/romm-dock/commit/734c25787143432a15d2af7fc6b825e229c9d1e2))
...
* **ci:** use uv --output-file= so Renovate can recompile the locks ([#1231](https://github.com/danielcopper/romm-tender/issues/1231)) ([38d14e1](https://github.com/Crimson3076/romm-dock/commit/38d14e16dedf71213b2c0f1b063f8f8dcc930947))
* **connection:** bind stored token to its minting server origin ([#1015](https://github.com/danielcopper/romm-tender/issues/1015), [#1038](https://github.com/danielcopper/romm-tender/issues/1038), [#1039](https://github.com/danielcopper/romm-tender/issues/1039)) ([#1089](https://github.com/danielcopper/romm-tender/issues/1089)) ([a94e3d9](https://github.com/Crimson3076/romm-dock/commit/a94e3d93b80dfa0f8840cd2cb45fa65c6419d7a7))
* **connection:** harden version gate against non-string SYSTEM.VERSION ([#1284](https://github.com/danielcopper/romm-tender/issues/1284)) ([f29f2f9](https://github.com/Crimson3076/romm-dock/commit/f29f2f9b25917806ea02baaedfe0e0eccb657f4b))
* **cores:** normalize RomM slug → RetroDECK system before core/gamelist seams ([#919](https://github.com/danielcopper/romm-tender/issues/919)) ([0e27f34](https://github.com/Crimson3076/romm-dock/commit/0e27f34fe377cf70d738bceeaaa9bd89eaf2e4d6)), closes [#906](https://github.com/danielcopper/romm-tender/issues/906)
* **cores:** resolve active core outside the open UoW ([#1283](https://github.com/danielcopper/romm-tender/issues/1283)) ([ac1757e](https://github.com/Crimson3076/romm-dock/commit/ac1757e5990671492b4ae1e549e4dd0c54828a0d)), closes [#1047](https://github.com/danielcopper/romm-tender/issues/1047) [#1134](https://github.com/danielcopper/romm-tender/issues/1134)
* **cores:** surface active-core fields on no-BIOS platforms so the per-game core menu renders ([#927](https://github.com/danielcopper/romm-tender/issues/927)) ([9da0926](https://github.com/Crimson3076/romm-dock/commit/9da0926f31c1f3055231f8e8908dc472cdbc58ab))
* **danger-zone:** remove live-scanned orphan shortcuts in remove-all and re-count after settle ([#1408](https://github.com/danielcopper/romm-tender/issues/1408)) ([d336fc8](https://github.com/Crimson3076/romm-dock/commit/d336fc8036dbd06dc6e394c1349e838925ffb768))
* **deps:** bump vulnerable transitive dev-deps to patched versions ([#1139](https://github.com/danielcopper/romm-tender/issues/1139)) ([a1aa7d5](https://github.com/Crimson3076/romm-dock/commit/a1aa7d59f243d368a727198b80e8519fd4f80559))
* **deps:** prune 5 obsolete pnpm overrides ([#1255](https://github.com/danielcopper/romm-tender/issues/1255)) ([e5a2d4d](https://github.com/Crimson3076/romm-dock/commit/e5a2d4d44285d2b6a74593f58d1c889c889a2ed3))
* **dev:** drop stale root-level defaults snapshots on deploy ([#1211](https://github.com/danielcopper/romm-tender/issues/1211)) ([cc721fc](https://github.com/Crimson3076/romm-dock/commit/cc721fcc3137f47eb0c6681e352df59f13e639b9))
* **dev:** reset plugin-dir ownership in dev's tty shell, not the piped deploy sub-run ([#1137](https://github.com/danielcopper/romm-tender/issues/1137)) ([170fa8e](https://github.com/Crimson3076/romm-dock/commit/170fa8ea762c5cacec660a70bd3020ab0ef37fe1))
* **downloads:** do not bake a launch command for a download the system cannot launch ([#1659](https://github.com/danielcopper/romm-tender/issues/1659)) ([19e8f1a](https://github.com/Crimson3076/romm-dock/commit/19e8f1ad0b638cb1c531e3c2e320a4ebc7c8519c))
* **downloads:** gate .m3u on ES-DE's per-system extension list ([#1111](https://github.com/danielcopper/romm-tender/issues/1111)) ([#1128](https://github.com/danielcopper/romm-tender/issues/1128)) ([88ee9ad](https://github.com/Crimson3076/romm-dock/commit/88ee9adafb6404909895f2fad164be0b892c54db))
* **downloads:** keep cleared downloads cleared, and fix cancel-while-paused + lingering cancelled rows ([#1446](https://github.com/danielcopper/romm-tender/issues/1446)) ([6a07017](https://github.com/Crimson3076/romm-dock/commit/6a07017d7985406fe3d094c47cd48db8fec641b6))
* **downloads:** name multi-file extract dir from the ROM identity, not files[0] ([#1307](https://github.com/danielcopper/romm-tender/issues/1307)) ([b5e82e0](https://github.com/Crimson3076/romm-dock/commit/b5e82e085b827c5f26fd2862f7b5fcdcb20e04db))
* **downloads:** notify download-store subscribers instead of polling ([#1773](https://github.com/danielcopper/romm-tender/issues/1773)) ([e3f7963](https://github.com/Crimson3076/romm-dock/commit/e3f7963bab5719bd80d0adf6d8235384b7e68875))
* **downloads:** show extraction progress + Steam-native cancel controls ([#1129](https://github.com/danielcopper/romm-tender/issues/1129)) ([69a7e91](https://github.com/Crimson3076/romm-dock/commit/69a7e9128e071045156872950ab802b4bee4b6a6))
...
* **errors:** report a definitive 404 as not_found, not server_unreachable ([#1571](https://github.com/danielcopper/romm-tender/issues/1571)) ([50234a5](https://github.com/Crimson3076/romm-dock/commit/50234a5d5514c4d39f906beea887a9250292f972))
* **errors:** require a RomM entity answer before a 404 becomes not-found ([#1622](https://github.com/danielcopper/romm-tender/issues/1622)) ([95ad514](https://github.com/Crimson3076/romm-dock/commit/95ad514a14ae4c1cb36bedc7ad97f27fcd99e8d9))
* **firmware:** read asdict bios files by key so per-platform BIOS delete works ([#931](https://github.com/danielcopper/romm-tender/issues/931)) ([691c0e7](https://github.com/Crimson3076/romm-dock/commit/691c0e76ee3400f29c7b195d2f106e03fefbae15))
* **firmware:** surface an "unmanaged" BIOS status for platforms without registry coverage ([#1531](https://github.com/danielcopper/romm-tender/issues/1531)) ([c626f6d](https://github.com/Crimson3076/romm-dock/commit/c626f6db7078f6eb50872acac154c408747b8c64)), closes [#1520](https://github.com/danielcopper/romm-tender/issues/1520)
* **launch:** bake the game folder as the PS3 launch target ([#1302](https://github.com/danielcopper/romm-tender/issues/1302)) ([ed00f88](https://github.com/Crimson3076/romm-dock/commit/ed00f882dc462dd18f35941cae0b0c2b389d0416))
...
* **launch:** read running apps only from SteamUIStore ([#1617](https://github.com/danielcopper/romm-tender/issues/1617)) ([9aef5e1](https://github.com/Crimson3076/romm-dock/commit/9aef5e1176c8d20eee58eb6cc860d5e9a6da6583)), closes [#1588](https://github.com/danielcopper/romm-tender/issues/1588)
* **launch:** stop only the RetroDECK instance running the pressed game ([#1620](https://github.com/danielcopper/romm-tender/issues/1620)) ([b9d6f0c](https://github.com/Crimson3076/romm-dock/commit/b9d6f0c760632db60703395130c1b504b9a15e5a)), closes [#1619](https://github.com/danielcopper/romm-tender/issues/1619)
* **library:** component-based sibling group keys with canonical-source agreement ([#1369](https://github.com/danielcopper/romm-tender/issues/1369)) ([5f8715b](https://github.com/Crimson3076/romm-dock/commit/5f8715b5367bca85c984e9494ffa94168fc1d0bd))
* **library:** count skip rows by fetch generation so superseded rows stop blocking ([#1513](https://github.com/danielcopper/romm-tender/issues/1513)) ([ce567c8](https://github.com/Crimson3076/romm-dock/commit/ce567c826c79a7f88e422011d37b90e9513648c0))
* **library:** heartbeat the shortcut scan and scan once per run ([#946](https://github.com/danielcopper/romm-tender/issues/946)) ([8010224](https://github.com/Crimson3076/romm-dock/commit/801022486a033bdc41dd3dab94674052f3574daa)), closes [#930](https://github.com/danielcopper/romm-tender/issues/930)
* **library:** materialize full enabled-platforms map so one un-toggle never disables others ([#1108](https://github.com/danielcopper/romm-tender/issues/1108)) ([db6f889](https://github.com/Crimson3076/romm-dock/commit/db6f889b21ef49c477382fd26c349271f0906cb1))
* **library:** re-confirm launch_options after a sync to heal skipped-platform drift ([#1151](https://github.com/danielcopper/romm-tender/issues/1151)) ([#1162](https://github.com/danielcopper/romm-tender/issues/1162)) ([8d23881](https://github.com/Crimson3076/romm-dock/commit/8d2388131be82734967d6fe7c6c8379b434738d3))
* **library:** re-confirm launch_options before a Play-button launch ([#1150](https://github.com/danielcopper/romm-tender/issues/1150)) ([#1160](https://github.com/danielcopper/romm-tender/issues/1160)) ([57da53b](https://github.com/Crimson3076/romm-dock/commit/57da53b1f9567d51100045742d9f88bbbec5175a))
* **library:** re-confirm launch_options on the watcher relaunch path too ([#1152](https://github.com/danielcopper/romm-tender/issues/1152)) ([#1164](https://github.com/danielcopper/romm-tender/issues/1164)) ([1bb8b96](https://github.com/Crimson3076/romm-dock/commit/1bb8b96c617c271f41b130eba8b4e14659719e84))
* **library:** reconcile drifted launch_options at startup ([#1043](https://github.com/danielcopper/romm-tender/issues/1043)) ([#1153](https://github.com/danielcopper/romm-tender/issues/1153)) ([495ebde](https://github.com/Crimson3076/romm-dock/commit/495ebdea21233fcd15ad2915caaa961cc5a460cf))
* **library:** reconcile Steam-UI-deleted shortcuts by unbinding dead appIds at sync start ([#1197](https://github.com/danielcopper/romm-tender/issues/1197)) ([23d3336](https://github.com/Crimson3076/romm-dock/commit/23d3336dcccbe4fd6a8cf0c889220ff6964bdaa8))
* **library:** reset kept shortcut launch_options after bulk uninstall ([#1146](https://github.com/danielcopper/romm-tender/issues/1146)) ([#1285](https://github.com/danielcopper/romm-tender/issues/1285)) ([397e122](https://github.com/Crimson3076/romm-dock/commit/397e122c7be5c069ef9c80bbb2614848cd4dc54c))
* **library:** reset shortcut launch_options to the uninstalled placeholder on uninstall ([#1051](https://github.com/danielcopper/romm-tender/issues/1051)) ([#1145](https://github.com/danielcopper/romm-tender/issues/1145)) ([9d60cd0](https://github.com/Crimson3076/romm-dock/commit/9d60cd032ef18ff2b9f778666667656f37cb887f))
* **library:** resolve relaunch options outside the read UoW to avoid a deadlock ([#1154](https://github.com/danielcopper/romm-tender/issues/1154)) ([#1155](https://github.com/danielcopper/romm-tender/issues/1155)) ([8b3c830](https://github.com/Crimson3076/romm-dock/commit/8b3c830773ce3c1bbbfe690ecbce8417146a6326))
* **library:** stop classifying the derived platform_name (permanent preview delta) ([#1306](https://github.com/danielcopper/romm-tender/issues/1306)) ([7d8a2b8](https://github.com/Crimson3076/romm-dock/commit/7d8a2b8ede5f7282a208b920f9693fe7ec7ed7f3)), closes [#1292](https://github.com/danielcopper/romm-tender/issues/1292)
* **migration:** chain pending homes so repeated moves never strand files ([#1282](https://github.com/danielcopper/romm-tender/issues/1282)) ([80d584b](https://github.com/Crimson3076/romm-dock/commit/80d584bee5a2503a62826191a799d84992a6ffee))
* **migration:** fail loud when the migration_blocked gate is unwired ([#970](https://github.com/danielcopper/romm-tender/issues/970)) ([#1093](https://github.com/danielcopper/romm-tender/issues/1093)) ([aba54ab](https://github.com/Crimson3076/romm-dock/commit/aba54ab329f31cd6f0b2513e775bba40457ee663))
* **paths:** surface RetroDECK config health instead of silent stale-root fallback ([#957](https://github.com/danielcopper/romm-tender/issues/957)) ([51c07a1](https://github.com/Crimson3076/romm-dock/commit/51c07a1aeb9e82ee989a97b71373146372dee645))
* **persistence:** BEGIN IMMEDIATE in the UoW to avoid un-retried SQLITE_BUSY_SNAPSHOT ([#1011](https://github.com/danielcopper/romm-tender/issues/1011)) ([#1092](https://github.com/danielcopper/romm-tender/issues/1092)) ([3674ef6](https://github.com/Crimson3076/romm-dock/commit/3674ef6f3b291252ae2b1ba5f3175b325b7ed3c6))
* **persistence:** crash-safe settings writes + corrupt-file quarantine ([#1010](https://github.com/danielcopper/romm-tender/issues/1010)) ([#1090](https://github.com/danielcopper/romm-tender/issues/1090)) ([d794705](https://github.com/Crimson3076/romm-dock/commit/d7947052d9fb5c4773e8ef742fe6b81ba3d9367d))
* **persistence:** surface settings-reset as a persistent acknowledgeable notice ([#1091](https://github.com/danielcopper/romm-tender/issues/1091)) ([99eadb1](https://github.com/Crimson3076/romm-dock/commit/99eadb1957fb23b4918a172e813b156867b91b65))
* **platforms:** map RomM's "new-nintendo-3ds" slug to the n3ds system ([#1689](https://github.com/danielcopper/romm-tender/issues/1689)) ([d331a61](https://github.com/Crimson3076/romm-dock/commit/d331a61c36a2c2ec738277990090c4284e6d735c)), closes [#1678](https://github.com/danielcopper/romm-tender/issues/1678)
* **platforms:** map the atari8bit, mac and sega32 slugs to their systems ([#1691](https://github.com/danielcopper/romm-tender/issues/1691)) ([dd0a21c](https://github.com/Crimson3076/romm-dock/commit/dd0a21cd93b742c12fc40602979424f6e036bf14))
* **platforms:** point both CD-i keys at the cdimono1 system ([#1702](https://github.com/danielcopper/romm-tender/issues/1702)) ([3762073](https://github.com/Crimson3076/romm-dock/commit/3762073d5e1dbfe8b7efc7ffa742884c94213132))
* **playtime:** adopt orphaned session after plugin reload ([#1289](https://github.com/danielcopper/romm-tender/issues/1289)) ([968aab1](https://github.com/Crimson3076/romm-dock/commit/968aab1f77bb77f031cb873a1684443877c3341c))
* **playtime:** drain server-rejected play sessions instead of retrying forever ([#1310](https://github.com/danielcopper/romm-tender/issues/1310)) ([5d6e925](https://github.com/Crimson3076/romm-dock/commit/5d6e92570528d973c35b754619071c44ffd19136))
* **playtime:** exclude suspend time via the monotonic clock ([#1316](https://github.com/danielcopper/romm-tender/issues/1316)) ([a34dfb9](https://github.com/Crimson3076/romm-dock/commit/a34dfb98c0c15f16446387e33d5a8875db97dd30))
* **playtime:** re-address the pending outbox when a device heals ([#1636](https://github.com/danielcopper/romm-tender/issues/1636)) ([72496e8](https://github.com/Crimson3076/romm-dock/commit/72496e88c2f30010573dbdb3903c08905c0f9c33))
* **playtime:** register renamed suspend hooks + robust session adoption ([#1308](https://github.com/danielcopper/romm-tender/issues/1308)) ([4b2db57](https://github.com/Crimson3076/romm-dock/commit/4b2db57558bf64321b3c2ba84d815412a013e173))
* **playtime:** sub-second sessions poison the whole ingest batch → 422 retry loop ([#1314](https://github.com/danielcopper/romm-tender/issues/1314)) ([5a7b3c9](https://github.com/Crimson3076/romm-dock/commit/5a7b3c9e4e9e52b66d33197206a10bd63d3abc05))
* **plugin:** remove the inert _root flag from plugin.json ([#1187](https://github.com/danielcopper/romm-tender/issues/1187)) ([0e753eb](https://github.com/Crimson3076/romm-dock/commit/0e753eb36b9fcb9be4f30ccb950477ecafd23a71)), closes [#1157](https://github.com/danielcopper/romm-tender/issues/1157)
* **saves:** adopt identical server save instead of POSTing a duplicate ([#1013](https://github.com/danielcopper/romm-tender/issues/1013)) ([#1099](https://github.com/danielcopper/romm-tender/issues/1099)) ([5e7dd62](https://github.com/Crimson3076/romm-dock/commit/5e7dd62cbb2b4a46e06cf76fc3dea835401c321a))
* **saves:** adopt instead of conflicting when both sides moved to identical content ([#1483](https://github.com/danielcopper/romm-tender/issues/1483)) ([d97958d](https://github.com/Crimson3076/romm-dock/commit/d97958dc604f632e5105a9b2e73d8cf4419e6f91))
* **saves:** branch-6 conflicts on baseline divergence instead of silent download ([#1059](https://github.com/danielcopper/romm-tender/issues/1059)) ([#1095](https://github.com/danielcopper/romm-tender/issues/1095)) ([06652d1](https://github.com/Crimson3076/romm-dock/commit/06652d132c50d818b72f522ead0d244606ed99fc))
* **saves:** cap .romm-backup growth and avoid same-second backup collisions ([#974](https://github.com/danielcopper/romm-tender/issues/974)) ([#1217](https://github.com/danielcopper/romm-tender/issues/1217)) ([580c756](https://github.com/Crimson3076/romm-dock/commit/580c756840287ba9549c1dd2b63e608323cd5baa))
* **saves:** check confirmSlotChoice success in the automated setup paths ([#1009](https://github.com/danielcopper/romm-tender/issues/1009)) ([#1141](https://github.com/danielcopper/romm-tender/issues/1141)) ([c8bfb25](https://github.com/Crimson3076/romm-dock/commit/c8bfb2509d7c56f92595e1781691aaf4d920c12d))
* **saves:** classify heartbeat and registration errors instead of masking as offline ([#1191](https://github.com/danielcopper/romm-tender/issues/1191)) ([ea4ffcf](https://github.com/Crimson3076/romm-dock/commit/ea4ffcfb54e485da7e1428fcf0e4b4fe2795a1b7))
* **saves:** client-authoritative conflict detection over negotiate ([#1234](https://github.com/danielcopper/romm-tender/issues/1234)) ([#1277](https://github.com/danielcopper/romm-tender/issues/1277)) ([52cfc54](https://github.com/Crimson3076/romm-dock/commit/52cfc54baa69b4248df69afbe26bab9af91f8641))
* **saves:** correct the get_save_slots active_slot type and record the setup-path divergence ([#1723](https://github.com/danielcopper/romm-tender/issues/1723)) ([971efa8](https://github.com/Crimson3076/romm-dock/commit/971efa86e577d640b202d1b6be58f6c5afe0db36))
* **saves:** drop foreign-rom negotiate ops in dispatch_negotiate_ops ([#1234](https://github.com/danielcopper/romm-tender/issues/1234)) ([#1268](https://github.com/danielcopper/romm-tender/issues/1268)) ([9bfeb59](https://github.com/Crimson3076/romm-dock/commit/9bfeb596d44844aa1be490684e5646db5c0ee6fd))
* **saves:** fall back to plain MD5 when a save sniffs as zip but is unreadable ([#1470](https://github.com/danielcopper/romm-tender/issues/1470)) ([#1474](https://github.com/danielcopper/romm-tender/issues/1474)) ([d786e33](https://github.com/Crimson3076/romm-dock/commit/d786e33f2c8b166d6f1103491a693c6f1d3e6472))
* **saves:** feed the kernel RomM's zip-aware content hash, not whole-file MD5 ([#1460](https://github.com/danielcopper/romm-tender/issues/1460)) ([465eff6](https://github.com/Crimson3076/romm-dock/commit/465eff69dc7d07aafa11c12536185732463bb86b)), closes [#1457](https://github.com/danielcopper/romm-tender/issues/1457)
* **saves:** forget device id on server-origin change ([#1234](https://github.com/danielcopper/romm-tender/issues/1234) phase 0a) ([#1258](https://github.com/danielcopper/romm-tender/issues/1258)) ([78eb8f3](https://github.com/Crimson3076/romm-dock/commit/78eb8f362f1ed35314f657bea622c54e3efdf4dc))
...
* **saves:** gate the in-place PUT against 0-byte / truncated local saves ([#1062](https://github.com/danielcopper/romm-tender/issues/1062)) ([#1107](https://github.com/danielcopper/romm-tender/issues/1107)) ([f11d7aa](https://github.com/Crimson3076/romm-dock/commit/f11d7aafa490f89ab3077ed12cd895fdb06a83e7))
* **saves:** group the matrix local-file loop by canonical target ([#1006](https://github.com/danielcopper/romm-tender/issues/1006)) ([#1096](https://github.com/danielcopper/romm-tender/issues/1096)) ([d33ba7f](https://github.com/Crimson3076/romm-dock/commit/d33ba7f818553d9d97989eac0b733554dbc184a1))
* **saves:** harden null-slot isolation via the shared save_in_slot funnel ([#877](https://github.com/danielcopper/romm-tender/issues/877)) ([#1476](https://github.com/danielcopper/romm-tender/issues/1476)) ([3bcf258](https://github.com/Crimson3076/romm-dock/commit/3bcf25808c5b2d6b1bb78764121314919a1eba87))
* **saves:** hold the per-ROM sync lock across slot mutations ([#1057](https://github.com/danielcopper/romm-tender/issues/1057)) ([#1100](https://github.com/danielcopper/romm-tender/issues/1100)) ([d01a3fd](https://github.com/Crimson3076/romm-dock/commit/d01a3fd5f91bbb7df65a4acd482bece95a2e5a39))
* **saves:** honor RomM's per-device sync-disabled switch as a policy stop ([#1489](https://github.com/danielcopper/romm-tender/issues/1489)) ([#1492](https://github.com/danielcopper/romm-tender/issues/1492)) ([ea38b0b](https://github.com/Crimson3076/romm-dock/commit/ea38b0b8d3ba730e164a3424f1791aa8fa6fbb06))
* **saves:** keep the device identity across same-server re-sign-ins ([#1438](https://github.com/danielcopper/romm-tender/issues/1438)) ([d1f7301](https://github.com/Crimson3076/romm-dock/commit/d1f7301763929b1424b44dfdebe3e6a87c75d467))
* **saves:** legacy-slot wire contract — address slot:null saves + explicit confirm_slot_choice ([#1061](https://github.com/danielcopper/romm-tender/issues/1061), [#1008](https://github.com/danielcopper/romm-tender/issues/1008), [#1004](https://github.com/danielcopper/romm-tender/issues/1004), [#1005](https://github.com/danielcopper/romm-tender/issues/1005)) ([#1102](https://github.com/danielcopper/romm-tender/issues/1102)) ([3e1864d](https://github.com/Crimson3076/romm-dock/commit/3e1864d3ae1dc0fd7ab577bc0f555be1ffd58c7c))
* **saves:** log dispatch-action sync errors ([#1234](https://github.com/danielcopper/romm-tender/issues/1234)) ([#1269](https://github.com/danielcopper/romm-tender/issues/1269)) ([c932937](https://github.com/Crimson3076/romm-dock/commit/c93293717f7e7fc60c61fad808cef781b1325258))
* **saves:** make switch_slot file handling coherent and backup-safe ([#1058](https://github.com/danielcopper/romm-tender/issues/1058), [#965](https://github.com/danielcopper/romm-tender/issues/965)) ([#1101](https://github.com/danielcopper/romm-tender/issues/1101)) ([24d93a9](https://github.com/Crimson3076/romm-dock/commit/24d93a9a8f0bee1b0c3f44171843ebc410044153))
* **saves:** make the legacy bucket fully read-only in the saves tab ([#1478](https://github.com/danielcopper/romm-tender/issues/1478)) ([#1496](https://github.com/danielcopper/romm-tender/issues/1496)) ([8bd01c7](https://github.com/Crimson3076/romm-dock/commit/8bd01c7db5acb02a09477eef0e9e4d87f5c39829))
* **saves:** make wizard legacy migration content-based with a local-save collision decision ([#1498](https://github.com/danielcopper/romm-tender/issues/1498)) ([#1507](https://github.com/danielcopper/romm-tender/issues/1507)) ([0575930](https://github.com/Crimson3076/romm-dock/commit/05759306d69abf2c5208cc6828f62100d5002d89))
* **saves:** name no slot until one has been answered ([#1753](https://github.com/danielcopper/romm-tender/issues/1753)) ([5bb0310](https://github.com/Crimson3076/romm-dock/commit/5bb0310614c878e5ceb598ef0c7059cdab87995d)), closes [#1747](https://github.com/danielcopper/romm-tender/issues/1747)
* **saves:** order save versions chronologically + persist rollback preflight on raise ([#1014](https://github.com/danielcopper/romm-tender/issues/1014), [#1012](https://github.com/danielcopper/romm-tender/issues/1012)) ([#1130](https://github.com/danielcopper/romm-tender/issues/1130)) ([08dab0f](https://github.com/Crimson3076/romm-dock/commit/08dab0fadde876a23bb2130577a1e2439f12ff5f))
* **saves:** re-register the device when RomM no longer has its id ([#1573](https://github.com/danielcopper/romm-tender/issues/1573)) ([d5b8b56](https://github.com/Crimson3076/romm-dock/commit/d5b8b5637ea20416448727731a1e635fc3284e0a))
* **saves:** refuse save upload when no device is registered ([#1494](https://github.com/danielcopper/romm-tender/issues/1494)) ([5dacb2a](https://github.com/Crimson3076/romm-dock/commit/5dacb2add8972ce030f57244665ab937289a032c))
* **saves:** reject the legacy bucket as a slot switch target ([#1478](https://github.com/danielcopper/romm-tender/issues/1478)) ([#1491](https://github.com/danielcopper/romm-tender/issues/1491)) ([1d84df7](https://github.com/Crimson3076/romm-dock/commit/1d84df796473559d85ccdaa1c13f7ad57eea2af7))
* **saves:** report a busy save-sync gate as busy, not as an offline server ([#1628](https://github.com/danielcopper/romm-tender/issues/1628)) ([be98159](https://github.com/Crimson3076/romm-dock/commit/be981596859fbad94d01364d4ba0b5ceecb87bae)), closes [#1625](https://github.com/danielcopper/romm-tender/issues/1625)
* **saves:** resolve canonical local target in dispatch_negotiate_ops ([#1234](https://github.com/danielcopper/romm-tender/issues/1234)) ([#1271](https://github.com/danielcopper/romm-tender/issues/1271)) ([e50d3bd](https://github.com/Crimson3076/romm-dock/commit/e50d3bd860eae977d1086796223426680cda956f))
* **saves:** roll back the in-memory device_name on a failed settings persist ([#1194](https://github.com/danielcopper/romm-tender/issues/1194)) ([44b352b](https://github.com/Crimson3076/romm-dock/commit/44b352b23912b51314f2d70c84306724d9782724))
* **saves:** route dedup-to-non-head upload responses to conflict ([#1482](https://github.com/danielcopper/romm-tender/issues/1482)) ([#1485](https://github.com/danielcopper/romm-tender/issues/1485)) ([e707566](https://github.com/Crimson3076/romm-dock/commit/e707566c062b9d95b355f9b49d8e4ddf4b15b0fb))
* **saves:** send autocleanup_limit on save upload so the setting caps retained versions ([#1060](https://github.com/danielcopper/romm-tender/issues/1060)) ([#1218](https://github.com/danielcopper/romm-tender/issues/1218)) ([9882d7d](https://github.com/Crimson3076/romm-dock/commit/9882d7d4a6583bdee5c77cab5b9f3f19acb89080))
* **saves:** skip launch-gate conflict round-trip when save sync is disabled ([#1056](https://github.com/danielcopper/romm-tender/issues/1056)) ([#1138](https://github.com/danielcopper/romm-tender/issues/1138)) ([58be248](https://github.com/Crimson3076/romm-dock/commit/58be248c03da49284f534673a08c93445ae4bdc0))
* **saves:** surface pre-launch and resolve-conflict failures without an errors array ([#1050](https://github.com/danielcopper/romm-tender/issues/1050)) ([#1142](https://github.com/danielcopper/romm-tender/issues/1142)) ([b2f1dc2](https://github.com/Crimson3076/romm-dock/commit/b2f1dc2ec9e5a94e80a78c3584e5a6d616f43229))
* **saves:** surface the classified reason for failed post-exit syncs and stop the panel's false synced state ([#1440](https://github.com/danielcopper/romm-tender/issues/1440)) ([2159223](https://github.com/Crimson3076/romm-dock/commit/215922330b98d4da1ac57cea2c5ccce125360830))
* **security:** reject path traversal in firmware/download joins via lib safe_join ([#1081](https://github.com/danielcopper/romm-tender/issues/1081)) ([48e8839](https://github.com/Crimson3076/romm-dock/commit/48e883989d24f6859c532d42a1032fba335f9cae)), closes [#966](https://github.com/danielcopper/romm-tender/issues/966) [#967](https://github.com/danielcopper/romm-tender/issues/967) [#968](https://github.com/danielcopper/romm-tender/issues/968)
* **session:** scope the lifecycle stop to the session's own app ([#1623](https://github.com/danielcopper/romm-tender/issues/1623)) ([7d8761e](https://github.com/Crimson3076/romm-dock/commit/7d8761ecd612bbd497e4e8e49057474603d5b474)), closes [#1621](https://github.com/danielcopper/romm-tender/issues/1621)
* **session:** track one play session per running app ([#1626](https://github.com/danielcopper/romm-tender/issues/1626)) ([889eca5](https://github.com/Crimson3076/romm-dock/commit/889eca598eac50e6ee6b3e3cd5def445f1b18f01)), closes [#1624](https://github.com/danielcopper/romm-tender/issues/1624) [#1589](https://github.com/danielcopper/romm-tender/issues/1589)
* **settings:** harden RomM sign-in and consolidate the connection/SteamGridDB UX ([#1565](https://github.com/danielcopper/romm-tender/issues/1565)) ([283134d](https://github.com/Crimson3076/romm-dock/commit/283134df6952b2d91ac0a94bd8a14dce7b09bc25)), closes [#1564](https://github.com/danielcopper/romm-tender/issues/1564)
* **settings:** purge retired romm_user/romm_pass keys from settings.json ([#1278](https://github.com/danielcopper/romm-tender/issues/1278)) ([bbc3eec](https://github.com/Crimson3076/romm-dock/commit/bbc3eec2548ee829e92c93f6bd7e98d2a292254d))
* **shortcuts:** escape quotes in launch_options path to block argv injection ([#1084](https://github.com/danielcopper/romm-tender/issues/1084)) ([16770f5](https://github.com/Crimson3076/romm-dock/commit/16770f551ded84c4fd94d824de76eafab4d4d45d)), closes [#969](https://github.com/danielcopper/romm-tender/issues/969)
...
* **sonar:** port the SonarCloud project-key fix from PR [#1](https://github.com/danielcopper/romm-tender/issues/1) ([7364b28](https://github.com/Crimson3076/romm-dock/commit/7364b285496c6ae864923300bfa3f60f5a7c1104))
* **sync/ui:** keep run history on Force Full Sync so the last-sync display stays truthful ([#1430](https://github.com/danielcopper/romm-tender/issues/1430)) ([b324dd5](https://github.com/Crimson3076/romm-dock/commit/b324dd5187bc4c6897e519d61099b84998fbdab9))
* **sync:** adopt orphan shortcuts by exe ownership and name instead of creating duplicates ([#1411](https://github.com/danielcopper/romm-tender/issues/1411)) ([c399334](https://github.com/Crimson3076/romm-dock/commit/c39933444d183ec0e9ea2064630577878754f8fa))
* **sync:** count delta-skipped roms in the processed-games numerator ([#1405](https://github.com/danielcopper/romm-tender/issues/1405)) ([6106a5c](https://github.com/Crimson3076/romm-dock/commit/6106a5c78be9ffa0b3b89dd0c3f0cfb6f51986b4))
* **sync:** count rebinding platforms correctly in the preview platform diff ([#1418](https://github.com/danielcopper/romm-tender/issues/1418)) ([024c904](https://github.com/Crimson3076/romm-dock/commit/024c904d8da9c307c84602e657d3247266bf3a9e))
* **sync:** finalize sync state on cancel during a unit's fetch phase ([#1035](https://github.com/danielcopper/romm-tender/issues/1035)) ([#1131](https://github.com/danielcopper/romm-tender/issues/1131)) ([4770855](https://github.com/Crimson3076/romm-dock/commit/4770855e00971f2f5851a07ceac9ad8ce2f209fd))
* **sync:** make late-ack recovery reachable via an abandoned-chunk stash ([#1409](https://github.com/danielcopper/romm-tender/issues/1409)) ([88abb37](https://github.com/Crimson3076/romm-dock/commit/88abb376b57f81b6bad66c2712619ca0d5fb8b33))
* **sync:** persist late-acked unit bindings + stop appId-reuse wiping a freshly-synced shortcut ([#1052](https://github.com/danielcopper/romm-tender/issues/1052), [#1036](https://github.com/danielcopper/romm-tender/issues/1036)) ([#1109](https://github.com/danielcopper/romm-tender/issues/1109)) ([2fdb145](https://github.com/Crimson3076/romm-dock/commit/2fdb14539c27ce3f74dd487ba2dc9809384894d7))
* **sync:** post-sync toast shows the true created/removed delta, not total_games ([#1112](https://github.com/danielcopper/romm-tender/issues/1112)) ([3e018de](https://github.com/Crimson3076/romm-dock/commit/3e018de02d4a19a04d2ed69a4896c55852168b36)), closes [#744](https://github.com/danielcopper/romm-tender/issues/744)
* **sync:** price a Force Full Sync's sibling duplicates as updates, not phantom creates ([#1519](https://github.com/danielcopper/romm-tender/issues/1519)) ([ea54e47](https://github.com/Crimson3076/romm-dock/commit/ea54e47e45f34db9c4810a9ac67c022ec3edd149)), closes [#1517](https://github.com/danielcopper/romm-tender/issues/1517)
* **sync:** price grandfathered sibling groups per bound duplicate in estimates ([#1404](https://github.com/danielcopper/romm-tender/issues/1404)) ([c2acb3b](https://github.com/Crimson3076/romm-dock/commit/c2acb3ba6167a563f9b891bff8a8f8746c887b73))
* **sync:** price the time estimate by composition and separate cover downloads ([#1515](https://github.com/danielcopper/romm-tender/issues/1515)) ([701edd0](https://github.com/Crimson3076/romm-dock/commit/701edd0940208a66d029892ba090d9dd9bc91e31)), closes [#1511](https://github.com/danielcopper/romm-tender/issues/1511)
* **sync:** re-apply overview metadata on sync_complete ([#1464](https://github.com/danielcopper/romm-tender/issues/1464)) ([7b60fc9](https://github.com/Crimson3076/romm-dock/commit/7b60fc9264cb6c69af818a098a7347aadb5e98f7))
* **sync:** refuse danger-zone removals while a sync run is in flight ([#1398](https://github.com/danielcopper/romm-tender/issues/1398)) ([0520634](https://github.com/Crimson3076/romm-dock/commit/0520634bf5e176e3200b198b9b14a069b3601387))
* **sync:** run the apply pipeline for unstamped platforms so recovery re-stamps and the run status heals ([#1421](https://github.com/danielcopper/romm-tender/issues/1421)) ([092fcf1](https://github.com/Crimson3076/romm-dock/commit/092fcf187a0bbf8a2b3763feadab864c7b211f9f))
* **sync:** scope cancel_sync to the active run so a stale cancel can't abort a fresh sync ([#1200](https://github.com/danielcopper/romm-tender/issues/1200)) ([c6a7f47](https://github.com/Crimson3076/romm-dock/commit/c6a7f475b27dc2e62b634ec86352d8b1fe8dd514))
* **sync:** single-owner run lifecycle — rapid Sync/Cancel no longer corrupts state ([#1202](https://github.com/danielcopper/romm-tender/issues/1202)) ([#1209](https://github.com/danielcopper/romm-tender/issues/1209)) ([c7d6020](https://github.com/Crimson3076/romm-dock/commit/c7d602040591f1342ccf48ea15163f1af381796e))
* **sync:** skip stale-collection cleanup on cancelled sync ([#1040](https://github.com/danielcopper/romm-tender/issues/1040)) ([#1106](https://github.com/danielcopper/romm-tender/issues/1106)) ([3a6c712](https://github.com/Crimson3076/romm-dock/commit/3a6c712b7bf9a1d7e1819829f7140f7a36ca852a))
* **sync:** surface cover-only changes in the preview and apply them ([#1406](https://github.com/danielcopper/romm-tender/issues/1406)) ([0b01726](https://github.com/Crimson3076/romm-dock/commit/0b017266dd5abc36e957eccd16c939cc00c5126b))
* **sync:** union same-named collections instead of overwriting in finalize ([#1533](https://github.com/danielcopper/romm-tender/issues/1533)) ([fb67d8a](https://github.com/Crimson3076/romm-dock/commit/fb67d8a3b17bc2732efe6cca39e38bdf13c8bfea)), closes [#1503](https://github.com/danielcopper/romm-tender/issues/1503)
* **sync:** validate run/unit identity on unit-result acks and stop sending after cancel ([#1196](https://github.com/danielcopper/romm-tender/issues/1196)) ([5b17f59](https://github.com/Crimson3076/romm-dock/commit/5b17f598eea457673441e7607f3113d0641f5b21))
* **tests:** stop conftest leaking temp dirs and being imported twice ([#1559](https://github.com/danielcopper/romm-tender/issues/1559)) ([e3ecbca](https://github.com/Crimson3076/romm-dock/commit/e3ecbca01a945bc6b4f011fe63ebe73af17eee6b))
* **ui:** acknowledge an already-synced manual save-sync click with an up-to-date toast ([#1486](https://github.com/danielcopper/romm-tender/issues/1486)) ([#1487](https://github.com/danielcopper/romm-tender/issues/1487)) ([deb78a1](https://github.com/Crimson3076/romm-dock/commit/deb78a15918ddcb3312f7c427e6c50d4fb9650f9))
* **ui:** apply RomM overview metadata with readiness retry ([#1203](https://github.com/danielcopper/romm-tender/issues/1203)) ([#1206](https://github.com/danielcopper/romm-tender/issues/1206)) ([8142a61](https://github.com/Crimson3076/romm-dock/commit/8142a6149a4b2edaae3148b6166149944c8f9848))
* **ui:** bind the game-detail store's async folds to the rom they were read for ([#1675](https://github.com/danielcopper/romm-tender/issues/1675)) ([f024631](https://github.com/Crimson3076/romm-dock/commit/f0246310e0a2e0530b28c6736cc870033b55343b))
* **ui:** bind the info panel's background reads to the rom they were issued for ([#1721](https://github.com/danielcopper/romm-tender/issues/1721)) ([220d8b2](https://github.com/Crimson3076/romm-dock/commit/220d8b263664f1a47985e394230a7ff917ee30cf))
* **ui:** bind the save tab's two write-backs to the rom they were issued for ([#1760](https://github.com/danielcopper/romm-tender/issues/1760)) ([91e7685](https://github.com/Crimson3076/romm-dock/commit/91e7685a0e9525dda9c723a3c2792b282efa949b))
* **ui:** bind the save-sync display note to the rom it describes ([#1715](https://github.com/danielcopper/romm-tender/issues/1715)) ([d0e81d0](https://github.com/Crimson3076/romm-dock/commit/d0e81d00d6297545613aa95ccf6bbb39185a29d9))
* **ui:** constrain qam loading spinners to a shared small inline pattern ([#1419](https://github.com/danielcopper/romm-tender/issues/1419)) ([3f737fe](https://github.com/Crimson3076/romm-dock/commit/3f737feac6c70330824246d76c20ca0d4476903d))
* **ui:** correct enable-save-sync modal claim that only .srm files sync ([#1471](https://github.com/danielcopper/romm-tender/issues/1471)) ([5cab3cc](https://github.com/Crimson3076/romm-dock/commit/5cab3cc2eb2ca705fb867d2ac7165b9444098b00)), closes [#1189](https://github.com/danielcopper/romm-tender/issues/1189)
* **ui:** disable cross-group versions in picker and make switch failure toasts readable ([#1361](https://github.com/danielcopper/romm-tender/issues/1361)) ([b8ea414](https://github.com/Crimson3076/romm-dock/commit/b8ea4141f89540ef6b166234203345b83cf9eeeb))
* **ui:** draw System-page BIOS dividers only between platforms ([#1535](https://github.com/danielcopper/romm-tender/issues/1535)) ([6662280](https://github.com/Crimson3076/romm-dock/commit/6662280d9c23d1014bc88fee5fab77a148229473))
* **ui:** floor the coarse progress bar at the leading zero-weight units' index share ([#1508](https://github.com/danielcopper/romm-tender/issues/1508)) ([33fb3a7](https://github.com/Crimson3076/romm-dock/commit/33fb3a7d1c297b154bb7b58f221fa6b21a3ba475))
* **ui:** follow the BIOS requirement across a version switch ([#1692](https://github.com/danielcopper/romm-tender/issues/1692)) ([79ca59b](https://github.com/Crimson3076/romm-dock/commit/79ca59b2b86e5981c72384068bae4783dc3cd00d))
* **ui:** gate collapsed platform counts on the completion stamp ([#1413](https://github.com/danielcopper/romm-tender/issues/1413)) ([0372fe8](https://github.com/Crimson3076/romm-dock/commit/0372fe8a862a105f1455d99c7034e83b3a7635ae))
* **ui:** hide Apply when the sync preview has no real collection delta ([#1287](https://github.com/danielcopper/romm-tender/issues/1287)) ([4085def](https://github.com/Crimson3076/romm-dock/commit/4085def80064b08fb363edf9ff691021c0bb68c1))
* **ui:** keep sync fine-detail rows mounted across unit boundaries ([#1420](https://github.com/danielcopper/romm-tender/issues/1420)) ([eea8196](https://github.com/Crimson3076/romm-dock/commit/eea81966fdfd3f9f2fffb457a0b509901dd1cbe0))
* **ui:** keep the play row mounted when the content-dir banner appears ([#1684](https://github.com/danielcopper/romm-tender/issues/1684)) ([db26ec8](https://github.com/Crimson3076/romm-dock/commit/db26ec8eeae1908338eb9a07431cfa30df959f24))
* **ui:** label the legacy/no-slot save bucket "Legacy" instead of "(no slot)" ([#1472](https://github.com/danielcopper/romm-tender/issues/1472)) ([0da0605](https://github.com/Crimson3076/romm-dock/commit/0da060518abb106593e300a8403491be0de0d4d1)), closes [#876](https://github.com/danielcopper/romm-tender/issues/876)
* **ui:** latch the coarse progress bar at its run high-water mark so a weight correction can't retract it ([#1525](https://github.com/danielcopper/romm-tender/issues/1525)) ([f67faae](https://github.com/Crimson3076/romm-dock/commit/f67faaea9dd61698b2f3f3a1c5c3c38b6738b136)), closes [#1509](https://github.com/danielcopper/romm-tender/issues/1509)
* **ui:** let the detail store recover from a read that threw ([#1763](https://github.com/danielcopper/romm-tender/issues/1763)) ([fd06559](https://github.com/Crimson3076/romm-dock/commit/fd06559f453adfbbb7cf8ddf95277fbc044ce17e))
* **ui:** let the game page go back for a BIOS answer it could not get ([#1761](https://github.com/danielcopper/romm-tender/issues/1761)) ([b1d0095](https://github.com/Crimson3076/romm-dock/commit/b1d0095c5139f07b5207bff6c70ab6d0aad6cdb0)), closes [#1752](https://github.com/danielcopper/romm-tender/issues/1752)
* **ui:** let the sync-progress store own whether a run is in flight ([#1775](https://github.com/danielcopper/romm-tender/issues/1775)) ([2a29dbf](https://github.com/Crimson3076/romm-dock/commit/2a29dbf60c2c97107b9afb2489934a077a4c6570)), closes [#1019](https://github.com/danielcopper/romm-tender/issues/1019)
* **ui:** live RomM connection state with offline fast paths, recovery, and switch-flow polish ([#1347](https://github.com/danielcopper/romm-tender/issues/1347)) ([f8f60ac](https://github.com/Crimson3076/romm-dock/commit/f8f60ac1798ee070cc412847f5cb33c25d6f4d51))
* **ui:** make the qam sync panel gamepad-navigable and compact its layout ([#1393](https://github.com/danielcopper/romm-tender/issues/1393)) ([47f052b](https://github.com/Crimson3076/romm-dock/commit/47f052b004833793d52b74fc507201ecfa6c8c5c))
* **ui:** offer a resume only while something is left to skip ([#1790](https://github.com/danielcopper/romm-tender/issues/1790)) ([50dc17a](https://github.com/Crimson3076/romm-dock/commit/50dc17acd66acc7081744562e58d9924787cbc62))
* **ui:** order the game detail store's loads so a slower one cannot reinstall a stale identity ([#1679](https://github.com/danielcopper/romm-tender/issues/1679)) ([6679b26](https://github.com/Crimson3076/romm-dock/commit/6679b265cfd17cb61ca7f2d874abb86ab911dd91))
* **ui:** order two game-detail reads for the same rom by when they were issued ([#1745](https://github.com/danielcopper/romm-tender/issues/1745)) ([dfb99ac](https://github.com/Crimson3076/romm-dock/commit/dfb99ac4f900795aada3334edbaf0645064f99b9))
* **ui:** pace mass shortcut removals through a shared paced-loop helper ([#1448](https://github.com/danielcopper/romm-tender/issues/1448)) ([a98f4ee](https://github.com/Crimson3076/romm-dock/commit/a98f4ee3a0aeccabfa8fbad9774cf1d3c3ba61bf))
* **ui:** per-game BIOS panel ignores bios change-events for other platforms ([#1083](https://github.com/danielcopper/romm-tender/issues/1083)) ([b44c6c7](https://github.com/Crimson3076/romm-dock/commit/b44c6c798a82c8a9deb34e85fdf0d148c208d353)), closes [#1082](https://github.com/danielcopper/romm-tender/issues/1082)
* **ui:** pin the fine-detail row height and name the next unit at sync boundaries ([#1435](https://github.com/danielcopper/romm-tender/issues/1435)) ([646a352](https://github.com/Crimson3076/romm-dock/commit/646a35239e7dd664b10d38542c3481d7a1699909))
* **ui:** prevent stale sgdb artwork apply from overwriting a newer one ([#1358](https://github.com/danielcopper/romm-tender/issues/1358)) ([6f832ee](https://github.com/Crimson3076/romm-dock/commit/6f832ee876597b0db4a435e3e67c8b096bca84b3))
* **ui:** re-read the installed rom on a version switch and drop the saves pane with its tab ([#1750](https://github.com/danielcopper/romm-tender/issues/1750)) ([7d47de3](https://github.com/Crimson3076/romm-dock/commit/7d47de3dc9e1a51ed46e42eb4070488c1d9d4899))
* **ui:** refresh game-detail ROM File section on download_complete ([#1342](https://github.com/danielcopper/romm-tender/issues/1342)) ([10182a0](https://github.com/Crimson3076/romm-dock/commit/10182a0df0e4d4ad5efdde5b138ac97ca2d6839b)), closes [#1340](https://github.com/danielcopper/romm-tender/issues/1340)
* **ui:** register new shortcuts as romm-owned at unit-ack time ([#1338](https://github.com/danielcopper/romm-tender/issues/1338)) ([3a68a2e](https://github.com/Crimson3076/romm-dock/commit/3a68a2e9fc687ad1c05e398ab10aafe9c8176ad2))
...
* **ui:** render qam active downloads with the bare progress-bar pattern so titles stop clipping ([#1445](https://github.com/danielcopper/romm-tender/issues/1445)) ([232a02e](https://github.com/Crimson3076/romm-dock/commit/232a02ee800363ba86d10c60cba7a065427c4efb))
* **ui:** render the rehydrated download button with the same colors as the live one ([#1447](https://github.com/danielcopper/romm-tender/issues/1447)) ([8064911](https://github.com/Crimson3076/romm-dock/commit/8064911d8305eb7d5261973f61baf320798f5b13))
* **ui:** report a downed plugin backend instead of spinning forever ([#1732](https://github.com/danielcopper/romm-tender/issues/1732)) ([6fddbb7](https://github.com/Crimson3076/romm-dock/commit/6fddbb7c600d1a826ded5a24a894294c4a82d7a6)), closes [#1730](https://github.com/danielcopper/romm-tender/issues/1730)
* **ui:** require would-be group key match for server-only siblings in picker and switch ([#1363](https://github.com/danielcopper/romm-tender/issues/1363)) ([7cf4205](https://github.com/Crimson3076/romm-dock/commit/7cf42056a430dd64f149ac3b3b679e73d80a84b1))
* **ui:** reset default save slot instead of a stale legacy-mode promise ([#1475](https://github.com/danielcopper/romm-tender/issues/1475)) ([97bfa60](https://github.com/Crimson3076/romm-dock/commit/97bfa60178ccf79bcb088da77f9ce761f5c11474)), closes [#1473](https://github.com/danielcopper/romm-tender/issues/1473)
* **ui:** say interrupted in the sync summary and use the planned total ([#1399](https://github.com/danielcopper/romm-tender/issues/1399)) ([0b38ed9](https://github.com/Crimson3076/romm-dock/commit/0b38ed92bb467140ad56b397e3d916e2820aba5e))
* **ui:** show cover-refresh progress instead of a frozen 0/0 ([#1456](https://github.com/danielcopper/romm-tender/issues/1456)) ([#1459](https://github.com/danielcopper/romm-tender/issues/1459)) ([878f19d](https://github.com/Crimson3076/romm-dock/commit/878f19dc9ec243f064b83b77e49aad07e328fadb))
* **ui:** show the per-game core-switch warning only when the filename triggers it ([#932](https://github.com/danielcopper/romm-tender/issues/932)) ([ba16d46](https://github.com/Crimson3076/romm-dock/commit/ba16d463d8ba958a0548ad680e4e687e40eb424d))
* **ui:** show the qam sync status smaller and green on success and keep it visible longer ([#1422](https://github.com/danielcopper/romm-tender/issues/1422)) ([0dee17c](https://github.com/Crimson3076/romm-dock/commit/0dee17c1de8609b121dbf6d2bf78ea62eb9b355f))
* **ui:** single save-compatibility banner + emit bios event on BIOS delete ([#940](https://github.com/danielcopper/romm-tender/issues/940)) ([69e2b1d](https://github.com/Crimson3076/romm-dock/commit/69e2b1d2ecacab01ac83c47205deaecad70b9096))
* **ui:** stop a save-status broadcast from overrunning the play button's transient states ([#1765](https://github.com/danielcopper/romm-tender/issues/1765)) ([1c50e13](https://github.com/Crimson3076/romm-dock/commit/1c50e130e61d48d6ed963820590af8580bf1201d))
* **ui:** stop reporting a slow connection check as "RomM offline" ([#1672](https://github.com/danielcopper/romm-tender/issues/1672)) ([3534f4b](https://github.com/Crimson3076/romm-dock/commit/3534f4bb03e900d62267bf8644f1130da2cdf209)), closes [#1670](https://github.com/danielcopper/romm-tender/issues/1670)
* **ui:** surface backend bootstrap failure instead of eternal "Checking…" ([#1286](https://github.com/danielcopper/romm-tender/issues/1286)) ([7dc03c0](https://github.com/Crimson3076/romm-dock/commit/7dc03c0e6f7d43f228d9b548bd0a9cd8f2407437))
* **ui:** System page lists only currently-synced systems ([#956](https://github.com/danielcopper/romm-tender/issues/956)) ([#960](https://github.com/danielcopper/romm-tender/issues/960)) ([8f3ec42](https://github.com/Crimson3076/romm-dock/commit/8f3ec42f0f72835bf56a6cd165bba7b9a0e538ad))
* **ui:** thread rom_filename so the game-detail reads the per-game active core ([#937](https://github.com/danielcopper/romm-tender/issues/937)) ([09de015](https://github.com/Crimson3076/romm-dock/commit/09de01586dbda5f443c835bd15cd23b79aa1ccfe))
* **uninstall:** a removal without a recovery bundle claims by identity, not by content ([#1667](https://github.com/danielcopper/romm-tender/issues/1667)) ([f8436cc](https://github.com/Crimson3076/romm-dock/commit/f8436ccfb709ccbf933bd26043ce13302cf98f1d)), closes [#1664](https://github.com/danielcopper/romm-tender/issues/1664)
* **version-picker:** disable versions missing from RomM ([#1575](https://github.com/danielcopper/romm-tender/issues/1575)) ([a10e2ab](https://github.com/Crimson3076/romm-dock/commit/a10e2ab841556f8aca424adb7fd80437724c8cd9))
* **version-switch:** refuse vanished targets ([#1576](https://github.com/danielcopper/romm-tender/issues/1576)) ([ee40268](https://github.com/Crimson3076/romm-dock/commit/ee40268ff1b0d2855727fc24f19411535d30a9e7))
...
* **artwork:** revalidate cached covers with a conditional request instead of re-downloading ([#1455](https://github.com/danielcopper/romm-tender/issues/1455)) ([5580aaa](https://github.com/Crimson3076/romm-dock/commit/5580aaac30cff4f6bd26a400e9de713a7aaa7512))
* **romm:** stop paying a full retry ladder per call while RomM is unreachable ([#1759](https://github.com/danielcopper/romm-tender/issues/1759)) ([189a186](https://github.com/Crimson3076/romm-dock/commit/189a1866954d20f3cab8e8a8b639ccb1ae82ebc4)), closes [#1758](https://github.com/danielcopper/romm-tender/issues/1758)
* **saves:** skip the post-upload confirm_download round-trip when the upload response proves is_current ([#1463](https://github.com/danielcopper/romm-tender/issues/1463)) ([66e564a](https://github.com/Crimson3076/romm-dock/commit/66e564a720c4011218087efab30475fd715a92ec))


### Miscellaneous Chores

* **persistence:** flag JSON→SQLite cutover as a breaking upgrade ([#913](https://github.com/danielcopper/romm-tender/issues/913)) ([07e0665](https://github.com/Crimson3076/romm-dock/commit/07e06659f9ca5c95491591bb7ba9c6a8a6dc99ba))
