...
If you discover a security vulnerability in RomM-Dock, please report it responsibly:

1. **Do NOT open a public GitHub issue.**
2. Use [GitHub Security Advisories](https://github.com/Crimson3076/romm-dock/security/advisories/new) to report
   privately.
3. Include:
