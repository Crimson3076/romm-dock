...
class Test025AddSelectedExe:
    """025 — adds the nullable selected_exe pin column to roms only, mirroring 004."""
    ...
    def test_selected_exe_absent_before_025(self, tmp_path: Path):
        db_path = str(tmp_path / "romm_sync.db")
