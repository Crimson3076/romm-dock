...
[`025_emulator_override_per_backend.sql`](https://github.com/danielcopper/decky-romm-sync/blob/main/backend/db/migrations/025_emulator_override_per_backend.sql)
