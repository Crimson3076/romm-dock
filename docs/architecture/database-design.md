...
which stamps `user_version = 2`. Migration
[`024_emulator_override_per_backend.sql`](https://github.com/danielcopper/decky-romm-sync/blob/main/py_modules/db/migrations/024_emulator_override_per_backend.sql)
later reshapes that same column's stored value — see below.
