...
__all__ = (
    ...
    # _vendor.backports_zstd._shutil
    'register_shutil',

    # _vendor.backports_zstd._zstdfile
    'open',
    'ZstdFile',

    # _vendor.backports_zstd._zstd
    'get_frame_size',
    'zstd_version',
    'zstd_version_info',
    'ZstdCompressor',
...
import _vendor.backports_zstd._zstd as _zstd
import enum
from _vendor.backports_zstd._zstd import (ZstdCompressor, ZstdDecompressor, ZstdDict, ZstdError,
                                  get_frame_size, zstd_version)
from _vendor.backports_zstd._zstdfile import ZstdFile, open, _nbytes
...
def __getattr__(name):
    if name == "register_shutil":
        from _vendor.backports_zstd._shutil import register_shutil
