...
vi.mock("../bigpicture/AdoptCandidateModal", () => ({
  showAdoptCandidateModal: vi.fn(),
}));
vi.mock("../bigpicture/AdoptCollisionModal", () => ({
  showAdoptCollisionModal: vi.fn(),
}));
vi.mock("../bigpicture/AdoptUnusableModal", () => ({
  showAdoptUnusableModal: vi.fn(),
}));
vi.mock("../bigpicture/AdoptVanishedModal", () => ({
